 ...
 * @author Aaron
 */
public class GUIinterfazMenuAdministrador extends javax.swing.JFrame {

    /**
     * Creates new form GUIinterfazMenuAdministrador
     */
    String nombreUsuario;
    
    public GUIinterfazMenuAdministrador(String nombre) {
        initComponents();
...
//            java.util.logging.Logger.getLogger(GUIinterfazMenuAdministrador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new GUIinterfazMenuAdministrador().setVisible(true);
//            }
//        });
//    }
